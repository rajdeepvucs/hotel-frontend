...
const TodayPayment = () => {
    ...
    // Function to get day of the week and format it with date
    ...
    const handleSearch = (e) => {
        ...
        const filtered = filteredAccount.filter((booking) =>
            ...
            booking.roomno.toString().includes(searchValue)
        );
    ...
    return (
        <div className='flex-1 overflow-auto relative z-10'>
           <Header title="Today's Accounts Detail" />
            <div className='mt-4 ml-8 text-xl font-bold text-gray-700'>
                        ...
                        <tbody className='divide-y divide-gray-700'>
                            {currentBooking?.map((booking) => (
                                ...
                                >
                                    ...
                                    <td className='px-3 py-4 whitespace-nowrap text-sm text-gray-800'>{booking.balenceAmount || 0}</td>
